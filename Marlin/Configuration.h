...
***********************************************************************/
/*
 ****   Hinweis: Arduino IDE auf "Board" = "Arduino/Genuino Mega or Mega 2560" setzen !
 ****
 */
/**
 * Equipment options
 ...
 */
#define NOZZLE_X          -6   // MR: -6 sollte korrekt sein 
#define NOZZLE_Y          -57  // MR: -57 sollte korrekt sein
...
#define CHANGE_E0_DIRECTION   // <- Notwendig für Tevo Titan Clone Extruder - If your extruder is going backwards, enable this.
 ...
 */
#define Z_STEPS      1634.414 // Stock lead screw
 ...
 */
#define SENSOR_LEFT        40 // MR: 40 sollte korrekt sein
#define SENSOR_RIGHT       0
#define SENSOR_FRONT       21 // MR: 21 sollte korrekt sein
...
// TODO MR: Wichtig! Sollte lt. div. Forum-Beiträgen eigentlich 0 sein. Setzte ich ihn aber auf 0, schlägt der compile fehl
// 9 und weniger geht nicht
// 10 und mehr geht ohne Fehler
...
#define CUSTOM_MACHINE_NAME "MR Tarantula"
...
#define HEATER_0_MINTEMP -10 // MR: Ist der Hotend-Thermistor nicht verbunden, liefert das Board ca. -15°C. Standard für den Wert ist 5.
#define HEATER_1_MINTEMP 5
#define HEATER_2_MINTEMP 5
#define HEATER_3_MINTEMP 5
#define HEATER_4_MINTEMP 5
#define BED_MINTEMP -10 // MR: Ist der Bed-Thermistor nicht verbunden, liefert das Board ca. -15°C. Standard für den Wert ist 5.
 ...
 */
#if ENABLED(DUAL_EXTRUDER)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.510, 79.920, Z_STEPS, E0_STEPS, E1_STEPS }
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.510, 79.920, Z_STEPS, E0_STEPS }
#endif
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.46   // Z offset: -below +above  [the nozzle] MR: -1.46 ist ganz gut, die erste schicht sieht aber arg gequetscht aus. Mit 3.0 sehen die gut aus.
...
#define X_BED_SIZE 200 // MR: Eigentlich 220, aber da die Düse nicht unter 5 mm und nicht über max-15 mm kommt, reduzieren wir auf 200
#if ENABLED(LARGE_BED)
  #define Y_BED_SIZE 280
#else
  #define Y_BED_SIZE 196 // MR: Eigentlich 220, aber da die Düse nicht über max-24 mm kommt, reduzieren wir auf 196
#endif
